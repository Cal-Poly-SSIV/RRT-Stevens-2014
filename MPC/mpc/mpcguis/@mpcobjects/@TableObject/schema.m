...
%  $Revision: 1.1.8.8 $ $Date: 2007/11/09 20:45:53 $
...
schema.prop(c, 'Defaults', 'MATLAB array');
...
% method signatures
  ...
  s4 = m4.Signature;
  s4.varargin    = 'off';
  s4.InputTypes  = {'handle','java.lang.Object','double','double'};
  s4.OutputTypes = {};

  m8 = schema.method(c, 'setSelectedRow');
  s8 = m8.Signature;
  s8.varargin    = 'off';
  s8.InputTypes  = {'handle','double'};
  s8.OutputTypes = {}; 
