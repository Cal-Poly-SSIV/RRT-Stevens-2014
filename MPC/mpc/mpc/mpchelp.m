...
%    $Revision: 1.1.6.5 $  $Date: 2007/11/09 20:38:51 $
...
switch nargin
    ...
    case 1
        % 1 input parameter.  Could be an MPC object, could be a property/method name
        ...
        if ~ischar(str)
            if isa(str, 'mpc')
                ...
                ctrlMsgUtils.error('MPC:object:InvalidMPCHelp1stType1');        
            end
        else
    ...
    case 2
        ...
        if ~isa(varargin{1}, 'mpc')
            ...
            ctrlMsgUtils.error('MPC:object:InvalidMPCHelp1stType2');                            
        end

        if ~ischar(varargin{2})
            ctrlMsgUtils.error('MPC:object:InvalidMPCHelp2ndType');                                        
        end
