...
static void initialize_c2_RSC_RRT_LiDAR_No_USER
  (SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct *chartInstance);
static void initialize_params_c2_RSC_RRT_LiDAR_No_USER
  (SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct *chartInstance);
static void enable_c2_RSC_RRT_LiDAR_No_USER
  (SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct *chartInstance);
static void disable_c2_RSC_RRT_LiDAR_No_USER
  (SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_RSC_RRT_LiDAR_No_USER
  (SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_RSC_RRT_LiDAR_No_USER
  (SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct *chartInstance);
static void set_sim_state_c2_RSC_RRT_LiDAR_No_USER
  (SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct *chartInstance, const mxArray *c2_st);
static void finalize_c2_RSC_RRT_LiDAR_No_USER
  (SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct *chartInstance);
static void sf_c2_RSC_RRT_LiDAR_No_USER(SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct
  *chartInstance);
static void compInitSubchartSimstructsFcn_c2_RSC_RRT_LiDAR_No_USER
  (SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct *chartInstance);
...
static void c2_emlrt_marshallIn(SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct
  *chartInstance, const mxArray *c2_MPC_state, const char_T *c2_name, real_T
  c2_y[6]);
static void c2_b_emlrt_marshallIn(SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct
  *chartInstance, const mxArray *c2_RRT_state, const char_T *c2_name, real_T
  c2_y[4]);
static uint8_T c2_c_emlrt_marshallIn(SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_RSC_RRT_LiDAR_No_USER, const
  char_T *c2_name);
static void init_dsm_address_info(SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct
  *chartInstance);
  ...
  (SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_RSC_RRT_LiDAR_No_USER = 0U;
}
  ...
  (SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct *chartInstance)
{
  ...
  c2_c_hoistedGlobal = chartInstance->c2_is_active_c2_RSC_RRT_LiDAR_No_USER;
  ...
  (SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct *chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_RSC_RRT_LiDAR_No_USER = c2_c_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 2)),
     "is_active_c2_RSC_RRT_LiDAR_No_USER");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_RSC_RRT_LiDAR_No_USER(chartInstance);
...
static const mxArray *c2_sf_marshall(void *chartInstanceVoid, void *c2_u)
{
  ...
  const mxArray *c2_b_y = NULL;
  SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct *chartInstance;
  chartInstance = (SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct *)chartInstanceVoid;
  c2_y = NULL;
...
const mxArray *sf_c2_RSC_RRT_LiDAR_No_USER_get_eml_resolved_functions_info(void)
{
...
static void c2_emlrt_marshallIn(SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct
  *chartInstance, const mxArray *c2_MPC_state, const char_T *
...
static void c2_b_emlrt_marshallIn(SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct
  *chartInstance, const mxArray *c2_RRT_state, const char_T
  *c2_name, real_T c2_y[4])
{
  real_T c2_dv4[4];
  int32_T c2_i29;
...
static uint8_T c2_c_emlrt_marshallIn(SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct
  *chartInstance, const mxArray *
  c2_b_is_active_c2_RSC_RRT_LiDAR_No_USER, const char_T *c2_name)
{
  uint8_T c2_y;
  uint8_T c2_u0;
  sf_mex_import(c2_name, sf_mex_dup(c2_b_is_active_c2_RSC_RRT_LiDAR_No_USER),
                &c2_u0, 1, 3, 0U, 0, 0U, 0);
  c2_y = c2_u0;
  sf_mex_destroy(&c2_b_is_active_c2_RSC_RRT_LiDAR_No_USER);
  return c2_y;
}
...
/* SFunction Glue Code */
void sf_c2_RSC_RRT_LiDAR_No_USER_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_RSC_RRT_LiDAR_No_USER_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c2_RSC_RRT_LiDAR_No_USER(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[18],T\"MPC_state\",},{M[1],M[10],T\"RRT_state\",},{M[8],M[0],T\"is_active_c2_RSC_RRT_LiDAR_No_USER\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_RSC_RRT_LiDAR_No_USER_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct *chartInstance;
    chartInstance = (SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct *)
...
static void sf_opaque_initialize_c2_RSC_RRT_LiDAR_No_USER(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_RSC_RRT_LiDAR_No_USER
    ((SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct*) chartInstanceVar);
  initialize_c2_RSC_RRT_LiDAR_No_USER((SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_RSC_RRT_LiDAR_No_USER(void *chartInstanceVar)
{
  enable_c2_RSC_RRT_LiDAR_No_USER((SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_RSC_RRT_LiDAR_No_USER(void *chartInstanceVar)
{
  disable_c2_RSC_RRT_LiDAR_No_USER((SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_RSC_RRT_LiDAR_No_USER(void *chartInstanceVar)
{
  sf_c2_RSC_RRT_LiDAR_No_USER((SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct*)
    chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c2_RSC_RRT_LiDAR_No_USER(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_RSC_RRT_LiDAR_No_USER
    ((SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c2_RSC_RRT_LiDAR_No_USER();/* state var info */
...
static void sf_internal_set_sim_state_c2_RSC_RRT_LiDAR_No_USER(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_RSC_RRT_LiDAR_No_USER();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c2_RSC_RRT_LiDAR_No_USER
    ((SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c2_RSC_RRT_LiDAR_No_USER(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_RSC_RRT_LiDAR_No_USER(S);
}

static void sf_opaque_set_sim_state_c2_RSC_RRT_LiDAR_No_USER(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c2_RSC_RRT_LiDAR_No_USER(S, st);
}

static void sf_opaque_terminate_c2_RSC_RRT_LiDAR_No_USER(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct*) chartInstanceVar)
      ->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_RSC_RRT_LiDAR_No_USER((SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct*)
      chartInstanceVar);
...
{
  compInitSubchartSimstructsFcn_c2_RSC_RRT_LiDAR_No_USER
    ((SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_RSC_RRT_LiDAR_No_USER(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_RSC_RRT_LiDAR_No_USER
      ((SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_RSC_RRT_LiDAR_No_USER(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable(S,"RSC_RRT_LiDAR_No_USER",
      "RSC_RRT_LiDAR_No_USER",2);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop(S,"RSC_RRT_LiDAR_No_USER",
                "RSC_RRT_LiDAR_No_USER",2,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop(S,"RSC_RRT_LiDAR_No_USER",
      "RSC_RRT_LiDAR_No_USER",2,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 2, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"RSC_RRT_LiDAR_No_USER",
        "RSC_RRT_LiDAR_No_USER",2,3);
      sf_mark_chart_reusable_outputs(S,"RSC_RRT_LiDAR_No_USER",
        "RSC_RRT_LiDAR_No_USER",2,2);
    }

    sf_set_rtw_dwork_info(S,"RSC_RRT_LiDAR_No_USER","RSC_RRT_LiDAR_No_USER",2);
...
static void mdlRTW_c2_RSC_RRT_LiDAR_No_USER(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_RSC_RRT_LiDAR_No_USER(SimStruct *S)
{
  SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct *chartInstance;
  chartInstance = (SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct *)malloc(sizeof
    (SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_RSC_RRT_LiDAR_No_USERInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_RSC_RRT_LiDAR_No_USER;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_RSC_RRT_LiDAR_No_USER;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_RSC_RRT_LiDAR_No_USER;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_RSC_RRT_LiDAR_No_USER;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_RSC_RRT_LiDAR_No_USER;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_RSC_RRT_LiDAR_No_USER;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_RSC_RRT_LiDAR_No_USER;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_RSC_RRT_LiDAR_No_USER;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_RSC_RRT_LiDAR_No_USER;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_RSC_RRT_LiDAR_No_USER;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_RSC_RRT_LiDAR_No_USER;
...
void c2_RSC_RRT_LiDAR_No_USER_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_RSC_RRT_LiDAR_No_USER(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_RSC_RRT_LiDAR_No_USER(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_RSC_RRT_LiDAR_No_USER(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_RSC_RRT_LiDAR_No_USER_method_dispatcher.\n"
